...
typedef struct {
  void *(*malloc_fcn)(void *userData, size_t size);
  void *(*realloc_fcn)(void *userData, void *ptr, size_t size);
  void (*free_fcn)(void *userData, void *ptr);
  void *allocData;
...
// // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // // //
// Changed to allow entity name reporting for subsequent diversion to skipped entity handler
// 11/9/03
typedef int (*XML_ExternalEntityRefHandler)(void *userData, const XML_Char *name);
/*
Original form:
