...
// This file produces 33 "unreferenced formal parameter" warnings on MS and CW
// This file produces 195 "conditional expression is constant" warnings on MS due to #defined constants used in conditionals
#if defined(__VC32__)
#pragma warning ( disable : 4100 )
#pragma warning ( disable : 4127 )

#if !defined(_DEBUG)
// This file produces 44 "unreachable code" warnings on MS for UREL builds
...
{ \
  ...
  for (from = *fromP; from != fromLim; from += 2) { \
    ...
    case 0x4: case 0x5: case 0x6: case 0x7: \
      ...
      *(*toP)++ = (char) ((lo >> 6) | (hi << 2) |  UTF8_cval2); \
      *(*toP)++ = (char) ((lo & 0x3f) | 0x80); \
      break; \
    default: \
      if (toLim -  *toP < 3)  { \
        *fromP = from; \
      ...
      *(*toP)++ = (char) ((hi >> 4) | UTF8_cval3); \
      *(*toP)++ = (char) (((hi & 0xf) << 2) | (lo >> 6) | 0x80); \
      *(*toP)++ = (char) ((lo & 0x3f) | 0x80); \
      break; \
    case 0xD8: case 0xD9: case 0xDA: case 0xDB: \
      if (toLim -  *toP < 4) { \
...
{ \
  ...
  for (; *fromP != fromLim && *toP != toLim; *fromP += 2) \
    *(*toP)++ = (unsigned short) ((GET_HI(*fromP) << 8) | GET_LO(*fromP)); \
}
