...
#ifndef __XMLOUTPUTCONTENTHANDLER_H__
#define __XMLOUTPUTCONTENTHANDLER_H__
...
class CXMLOutputContentHandler : public CBase, public MContentHandler
{

public:

	static CXMLOutputContentHandler* NewL();
	static CXMLOutputContentHandler* NewLC();
	
	~CXMLOutputContentHandler();
...
#endif //__XMLOUTPUTCONTENTHANDLER_H__