...
CXMLOutputContentHandler* CXMLOutputContentHandler::NewL()
	{
	CXMLOutputContentHandler* tester = new (ELeave) CXMLOutputContentHandler();
...
CXMLOutputContentHandler* CXMLOutputContentHandler::NewLC()
	{
	CXMLOutputContentHandler* tester = new (ELeave) CXMLOutputContentHandler();
	CleanupStack::PushL(tester);
	tester->ConstructL();
...
CXMLOutputContentHandler::~CXMLOutputContentHandler()
	{
	}
...
void CXMLOutputContentHandler::ConstructL()
{
}
...
*/
void CXMLOutputContentHandler::OnStartDocumentL(const RDocumentParameters& /*aDocParam*/, TInt /*aErrorCode*/)
{
}
...
@param				aErrorCode is the error code. 
					If this is not KErrNone then special action may be required.
*/
void CXMLOutputContentHandler::OnEndDocumentL(TInt /*aErrorCode*/)
{
}
...
@param				aErrorCode is the error code.
					If this is not KErrNone then special action may be required.
*/
void CXMLOutputContentHandler::OnStartElementL(const RTagInfo& /*aElement*/,
...
@param				aErrorCode is the error code.
					If this is not KErrNone then special action may be required.
*/
void CXMLOutputContentHandler::OnEndElementL(const RTagInfo& /*aElement*/, TInt /*aErrorCode*/)
{
}
...
@param				aErrorCode is the error code.
					If this is not KErrNone then special action may be required.
*/
void CXMLOutputContentHandler::OnContentL(const TDesC8& /*aBytes*/, TInt /*aErrorCode*/)
{
}
...
@param				aErrorCode is the error code.
					If this is not KErrNone then special action may be required.
*/
void CXMLOutputContentHandler::OnStartPrefixMappingL(const RString& /*aPrefix*/, const RString& /*aUri*/, 
									   TInt /*aErrorCode*/)
{
}
...
@param				aErrorCode is the error code.
					If this is not KErrNone then special action may be required.
*/
void CXMLOutputContentHandler::OnEndPrefixMappingL(const RString& /*aPrefix*/, TInt /*aErrorCode*/)
{
}
...
@param				aErrorCode is the error code.
					If this is not KErrNone then special action may be required.
*/
void CXMLOutputContentHandler::OnIgnorableWhiteSpaceL(const TDesC8& /*aBytes*/, TInt /*aErrorCode*/)
{
}
...
@param				aErrorCode is the error code.
					If this is not KErrNone then special action may be required.
*/
void CXMLOutputContentHandler::OnSkippedEntityL(const RString& /*aName*/, TInt /*aErrorCode*/)
{
}
...
@param				aErrorCode is the error code.
					If this is not KErrNone then special action may be required.
*/
void CXMLOutputContentHandler::OnProcessingInstructionL(const TDesC8& /*aTarget*/,
										  const TDesC8& /*aData*/, 
										  TInt /*aErrorCode*/)
{
}
...
*/
void CXMLOutputContentHandler::OnError(TInt /*aErrorCode*/)
{
}
...
*/
TAny* CXMLOutputContentHandler::GetExtendedInterface(const TInt32 /*aUid*/)
{
	return 0;	
}
