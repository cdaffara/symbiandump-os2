...
#include "syncml1_2stringdictionary00.h"
#include "syncml1_2codepage00tagtable.h"

using namespace Xml;

Xml::MStringDictionary* CSyncml1_2StringDictionary00::NewL(TAny* aStringPool)
	{
	CSyncml1_2StringDictionary00* self = new(ELeave) CSyncml1_2StringDictionary00(reinterpret_cast<RStringPool*>(aStringPool));
...
CSyncml1_2StringDictionary00::CSyncml1_2StringDictionary00(RStringPool* aStringPool)
...
void CSyncml1_2StringDictionary00::ConstructL()
	{
	// we don't own this stringpool
	iStringPool.OpenL(Syncml1_2CodePage00TagTable::Table);

	iCodepage00Table = Xml::CDictionaryCodePage::NewL(&Syncml1_2CodePage00TagTable::Table, 0, 0, 0);
...
void CSyncml1_2StringDictionary00::Release()
	{
	delete (this);
	}
...
CSyncml1_2StringDictionary00::~CSyncml1_2StringDictionary00()
	{
	if (iCodepage00Table)
		{
...
void CSyncml1_2StringDictionary00::ElementL(TInt aToken, RString& aElement) const
	{
...
void CSyncml1_2StringDictionary00::AttributeL(TInt /*aToken*/, RString& /*aAttribute*/) const
	{
...
void CSyncml1_2StringDictionary00::AttributeValuePairL(TInt /*aToken*/, RString& /*aAttribute*/, RString& /*aValue*/) const
	{
	// SyncML does not have attributes
	User::Leave(KErrXmlUnsupportedAttribute);
	};
...
void CSyncml1_2StringDictionary00::AttributeValueL(TInt /*aToken*/, RString& /*aValue*/) const
	{
	// SyncML does not have attributes
...
TBool CSyncml1_2StringDictionary00::CompareThisDictionary(const RString& aDictionaryDescription) const
	{
	...
	return (
		(aDictionaryDescription == iStringPool.String(Syncml1_2CodePage00TagTable::EUrn, Syncml1_2CodePage00TagTable::Table))		||
		(aDictionaryDescription == iStringPool.String(Syncml1_2CodePage00TagTable::EPublicId, Syncml1_2CodePage00TagTable::Table))||
		(aDictionaryDescription == iStringPool.String(Syncml1_2CodePage00TagTable::EFormalPublicId, Syncml1_2CodePage00TagTable::Table)));
	}



TInt CSyncml1_2StringDictionary00::SwitchCodePage(TInt aCodePage)
	{
