...
/**
@SYMTestCaseID 		 		SYSLIB-XML-CT-3729
@SYMTestCaseDesc		    Parsing large documents.
@SYMTestPriority 		    Medium
@SYMTestActions  		    Parsing large documents and comparing the output.
@SYMTestExpectedResults 	Parsed documents and expected output should match.
@SYMREQ 		 		 	REQ0000
*/
static void ParserTestsL()
	{
	test.Next(_L(" @SYMTestCaseID:SYSLIB-XML-CT-3729 ParserTestsL tests... "));
	...
	CStabilityTestClass* parserTest = CStabilityTestClass::NewL(test, ETrue, KMaxChunkSize);
